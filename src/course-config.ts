...
export const courseMeta = slopCourseMetaSchema.parse({
  ...
  endDate: "2027-05-17",
  description:
    "A postgraduate seminar treating forest fungal networks as a diplomatic " +
    "system: trade agreements, espionage, sanctions and betrayal beneath " +
    "the soil.",
  tags: ["mycology", "network theory", "diplomacy"],
}) satisfies CourseMetaInput;

/** Numeric file number taken from the code (SLOP6674 → 6674). */
